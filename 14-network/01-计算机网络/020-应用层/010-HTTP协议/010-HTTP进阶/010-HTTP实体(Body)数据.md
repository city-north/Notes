...
![image-20210123221907632](../../../../../assets/image-20210123221907632.png)
...
<img src="../../../../../assets/image-20210123230404748.png" alt="image-20210123230404748" style="zoom:33%;" />

## 课下作业

1. 试着解释一下这个请求头“Accept-Encoding: gzip, deflate;q=1.0, *;q=0.5, br;q=0”，再模拟一下服务器的响应头。

   > 接受压缩方式为gzip的权重为1，deflate权重为1，其他的为0.5，br拒绝。
