...
1. Cookie 是**服务器委托浏览器**存储的一些数据，让服务器有了“记忆能力”；
...
Cookie 是**服务器委托浏览器**存储的一些数据，让服务器有了“记忆能力”,用到了响应头字段**Set-Cookie**和请求头字段**Cookie**。
...
![image-20210124200125214](../../../../../assets/image-20210124200125214.png)
...
![image-20210124200209924](../../../../../assets/image-20210124200209924.png)

然后刷新这个页面，浏览器就会在请求头里自动送出 Cookie，服务器就能认出你了。

![image-20210124200226154](../../../../../assets/image-20210124200226154.png)
...
![image-20210124200406158](../../../../../assets/image-20210124200406158.png)
...
![image-20210124200607390](../../../../../assets/image-20210124200607390.png)

![image-20210124200911652](../../../../../assets/image-20210124200911652.png)
...
- Cookile 这个词来源于计算机编程的术语(Magic Cookie), 意思是不透明的数据, 并不是小甜饼的含义

- 早期Cookie 直接就是磁盘上的小文本文件, 现在基本上都是以数据库记录的形式存放的(通常使用的是Sqllite), 浏览器对Cookie 的数量和大小也是有限制的, 不允许无线存储, 一般总大小不能超过4K
- 如果不指定Expores桌和Max-Age属性, 那么Cookie仅仅在浏览器运行时有效, 一旦浏览器关闭就会失效, 这被成为会话Cookie( Session Cookie) 或者内存 Cookie (In-Memory cookie) 在Chrome 里过期时间会显示为 Session或者 "N/A"
