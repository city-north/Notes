...
#### 用过redis么用redis都做了什么
 ...
 [012-用过redis么用redis都做了什么.md](012-用过redis么用redis都做了什么.md) 
...
#### Redis为什么快
 ...
 [006-Redis为什么快.md](006-Redis为什么快.md) 

#### 什么是缓存击穿、缓存穿透、缓存雪崩？

[008-什么是缓存击穿-缓存穿透-缓存雪崩.md](008-什么是缓存击穿-缓存穿透-缓存雪崩.md) 

#### Redis的过期策略有哪些

 [009-Redis的过期策略有哪些.md](009-Redis的过期策略有哪些.md) 
...
>
> 6.什么是缓存穿透？如何避免？什么是缓存雪崩？何如避免？  缓存失效
>
> 7.Redis常用命令
>
...
1. [Redis支持哪些数据类型?](010-Redis/010-Redis支持哪些数据类型.md) 

2. [介绍一下Redis持久化机制](010-Redis/011-介绍一下Redis持久化机制.md) 
...
- 通过配置参数,通过一定的周期看,命令执行的个数,超过阈值则执行快照生成
