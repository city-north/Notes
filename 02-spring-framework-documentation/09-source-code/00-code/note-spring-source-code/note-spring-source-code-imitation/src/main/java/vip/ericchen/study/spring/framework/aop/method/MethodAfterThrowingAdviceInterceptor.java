 ...
 */
public class MethodAfterThrowingAdviceInterceptor extends AbstractAspectAdviceInterceptor {


    public MethodAfterThrowingAdviceInterceptor(Method aspectMethod, Object aspectObject) {
