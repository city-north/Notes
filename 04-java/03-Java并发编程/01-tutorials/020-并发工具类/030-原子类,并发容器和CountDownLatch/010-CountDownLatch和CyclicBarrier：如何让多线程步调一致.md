...
## 知识点参考
 ...
 [02-同步屏障-CyclicBarrier.md](../../../10-Java中的并发工具类/02-同步屏障-CyclicBarrier.md) 
...
<img src="../../../../../assets/image-20210201190201229.png" alt="image-20210201190201229" style="zoom:67%;" />
...
<img src="../../../../../assets/image-20210201190215890.png" alt="image-20210201190215890" style="zoom:67%;" />
...
<img src="../../../../../assets/image-20210201190227795.png" alt="image-20210201190227795" style="zoom:67%;" />
...
- 如果计数器等于 0，则通知线程 T3，并唤醒等待的线程 T1 或者 T2，与此同时，将计数器重置为 2，这样线程 T1 和线程 T2 生产下一条数据的时候就可以继续使用这个计数器了。
...
线程池大小为1是必要的，如果设置为多个，有可能会两个线程 A 和 B 同时查询，A 的订单先返回，B 的派送单先返回，造成队列中的数据不匹配；所以1个线程实现生产数据串行执行，保证数据安全
 ...
 [README.md](../080-并发工具类模块热点问题答疑/README.md) 
