# 018-StampedLock比读写锁更快的锁

[TOC]

## StampedLock的笔记

 [052-StampedLock.md](../07-线程中的锁/052-StampedLock.md) 

## 比ReadWriteLock性能还要好的锁

Java 在 1.8 这个版本里，提供了一种叫 StampedLock 的锁，它的性能就比读写锁还要好。

## 1. StampedLock支持的三种锁模式
...
#### 1.2 为什么StampedLock性能好于ReadWriteLock 
...
文中下面这段代码是出自 Java SDK 官方示例，并略做了修改。
