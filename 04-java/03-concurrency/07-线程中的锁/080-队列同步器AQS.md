...
>
> 是一个 FIFO 的双向队列, 其内部维护了head 和 tail 节点 来指向队首和队尾元素, AQS 中维护了一个单一的状态信息 state , 通过 CAS 算法管理这个值
>
...
#### 独占式方式和共享式方式访问资源的方式有什么区别

>  [081-AQS-独占方式下获取和释放资源的流程.md](081-AQS-独占方式下获取和释放资源的流程.md)  [082-AQS-共享方式下获取和释放资源的流程.md](082-AQS-共享方式下获取和释放资源的流程.md) 
